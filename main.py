...
def main():
    ...
    # Note: Removing Songs by The Strokes for recommending, but can inset any artist as the fourth parameter 
    song_df = neo4j_api.load_data(file_path, 1000, rachlin_songs_track_ids, "The Strokes")
